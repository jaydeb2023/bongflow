  ...
  return (
    ...
    >
      ...
      >
        ...
        <h1
          className="text-4xl font-bold mb-4 bengali leading-tight"
          style={{ color: "var(--text-primary)" }}
        >
          ...
          {[
            ...
            >
              ...
              <div
                ...
                style={{ color: plan.highlight ? "var(--green)" : "inherit" }}
              >
                <span
                  className="text-3xl font-bold"
                  style={{ color: plan.highlight ? "var(--green)" : "var(--text-primary)" }}
                >
                  {plan.price}
                </span>
                <span
      ...
      <footer
        ...
        style={{ color: "var(--text-muted)", borderTop: "1px solid #e5e7eb", paddingTop: "1rem" }}
      >
