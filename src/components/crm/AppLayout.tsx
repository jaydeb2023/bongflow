    ...
    <div className="flex h-screen overflow-hidden" style={{ background: 'var(--bg-primary)' }}>
      ...
      >
        ...
        <div
          ...
          style={{ borderBottom: '0.5px solid var(--border)', height: 52 }}
        >
          <div
            className="shrink-0 flex items-center justify-center rounded-lg text-sm font-bold"
            style={{ width: 32, height: 32, background: 'var(--wa-green)', color: '#fff' }}
          >
            🐯
          </div>
          {!collapsed && (
            <div>
              <div className="text-sm font-bold" style={{ color: 'var(--text-primary)', lineHeight: 1.2 }}>
                BongoFlow
              </div>
              <div className="text-xs" style={{ color: 'var(--text-muted)' }}>AI CRM</div>
            </div>
          )}
          <button
